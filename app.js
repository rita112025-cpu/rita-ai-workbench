const tools = [
  ...
  {name:"daily-report-viewer-work-prompts",repo:"daily-report-viewer-work-prompts",owner:"rita112025-cpu",category:"常用 Prompt",description:"工作日報 Prompt。",detail:"用來整理工作日誌、進度、成果、風險與下一步。",tags:["日報","Prompt","工作整理"],status:"常用",github:"https://github.com/rita112025-cpu/daily-report-viewer-work-prompts",demo:""},
  ...
  {name:"daily-report-viewer",repo:"daily-report-viewer",owner:"rita112025-cpu",category:"工作自動化工具",description:"日報查看器。",detail:"用於查看、整理或展示工作日報與進度資料。",tags:["日報","Viewer","工作追蹤"],status:"常用",github:"https://github.com/rita112025-cpu/daily-report-viewer",demo:""},
