const tools = [
  ...
  {name:"Six-Skills-Dashboard",repo:"Six-Skills-Dashboard",owner:"rita112025-cpu",category:"Claude Code 分工",description:"Agent Skill 總覽儀表板。",detail:"16 個 skill（6 核心 + 10 堆疊）集中管理，含階段篩選、互動評分、一鍵複製安裝路徑與 7 步工作流程圖。單檔 HTML、零依賴。",tags:["Skill","Dashboard","Agent"],status:"常用",github:"https://github.com/rita112025-cpu/Six-Skills-Dashboard",demo:"https://rita112025-cpu.github.io/Six-Skills-Dashboard/"},
...
const categories = ["常用 Prompt","Codex 工具","Claude Code 分工","工作自動化工具","AI 實驗 / Demo","工程 / 報價工具","學習與資源","生活 / 其他"];
